...
def gpon_trafego():
    if request.method == 'POST':
        ...
        file2 = make_one_upload(request, configs["ports_filepath"])
        file3 = make_one_upload(request, configs["ring_filepath"])
        file4 = make_one_upload(request, configs["exceptions_filepath"])
